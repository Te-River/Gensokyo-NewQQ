...
func (o *openAPIv2) CreateSession(ctx context.Context, identity dto.HTTPIdentity) (*dto.HTTPReady, error) {
...
func (o *openAPIv2) CheckSessions(ctx context.Context) ([]*dto.HTTPSession, error) {
	resp, err := o.request(ctx).
...
func (o *openAPIv2) RemoveSession(ctx context.Context, sessionID string) error {
	_, err := o.request(ctx).
